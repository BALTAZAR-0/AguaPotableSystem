...
$itemConsumoMes = "idservicio";
$valorConsumoMes = $respuesta[0]['idservicio'];

$respuestaConsumoMes = ControladorContratos::ctrMostrarServicioRecibo($itemConsumoMes, $valorConsumoMes);
$consumoMes = json_decode($respuestaConsumoMes["lecturamedidor"], true);
...
$consumoAnteriorOK=$lecturaActual-$consumoMes;
...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Image($image_file, 10, 4, 200, 23, 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
		/*
...
<table border="0" cellspacing="3" cellpadding="4">
    ...
    <tr>
        <th width="380">
        	<table cellpadding="3">
				<tr style="background-color: '.$colorE.'; color: #fff; font-size: 16px;">
        ...
        <th align="center" width="auto" style="font-size: 16px; color: '.$color_titulos.'">
        		<br>
        		Lectura Anterior : '.$consumoAnteriorOK.'
        		<br>
        		Lectura Actual: '.$resp_lecturaanterior["totalM3"].'
	        	<br>
	        	Consumo del Mes : '.$consumoMes.'
	        	<br>
        ...
        <th>
			...
			<table cellpadding="4" align="center">
				<tr style="background-color: '.$colorE.'; color: #fff; font-size: 14px;">
					...
					<th width="20%" style="border: 0.5px solid '.$colorE.'; font-size: 16px;">
						Total Pagar:
					</th>
					<th width="20%" style="border: 0.5px solid '.$colorE.'; font-size: 16px;">
						'.$totalPagar.'
				...
				<tr style="font-size: 16px;">
					<td width="100%" align="center">
						<h2 color="'.$color_titulos.'">
							...
							<SMALL><B>ATENCIÓN DEL POR EL SERVICIO DE AGUA LOS DIAS LUNES A DOMINGO</B></SMALL>
						</h2>
					</td>
				</tr>
			</table>
    	...
    	<td>
			...
			<table cellpadding="4" align="center">
				<tr style="font-size: 14px;">
					<th width="60%">
						<img src="'.K_PATH_IMAGES.'header_reportes.png" height="200"/>
					</th>					
        ...
        <th width="360">
			...
			<table cellpadding="4" align="center">
				<tr style="background-color: '.$colorE.'; color: #fff; font-size: 14px;">
					...
					<th width="80%" style="border: 0.5px solid '.$colorE.'; font-size: 16px;">
						Total Pagar:
					</th>
					<th width="40%" style="border: 0.5px solid '.$colorE.'; font-size: 16px;">
						'.$totalPagar.'
					</th>
				</tr>
